...
def generate_launch_description():
    ...
    ld.add_action(with_rviz); ld.add_action(with_octomap) # new octomap
    ld.add_action(with_aruco)
    ld.add_action(x_arg); ld.add_action(y_arg); ld.add_action(z_arg)
    ld.add_action(aruco_marker_id); ld.add_action(aruco_marker_size)
    ...
    # # using the launch file for the world of the sim
    # world_file = os.path.join(
    #     get_package_share_directory('ur_yt_sim'), 'worlds', 'world3.world'
    # )
    ...
    # remember to add world file after paused above for a world 'world' : world_file
    )
    ...
    # rail_velocity_controller_spawner = Node(
    # package="controller_manager",
    # executable="spawner",
    # arguments=["rail_velocity_controller", "-c", "/controller_manager"],
    # output="screen",
    # )   
